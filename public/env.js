          ...
          if (clickCount == 6) {
            $.ajax({
              ...
              success: function (data) {
                ...
                $('#hand-panel-ccs').append(
                  `<img id="ccName" class="hand-panel-cc" src='${data.updatePlayers[0].ccsArray.location}'>`
                );
          ...
          if (clickCount == 8) {
            $.ajax({
              ...
              success: function (data) {
                ...
                $('#hand-panel-ccs').append(
                  `<img id="ccName" class="hand-panel-cc" src='${data.updatePlayers1[1].ccsArray.location}'>`
                );
          ...
          if (clickCount == 10) {
            $.ajax({
              ...
              success: function (data) {
                ...
                $('#hand-panel-ccs').append(
                  `<img id="ccName" class="hand-panel-cc" src='${data.updatePlayers2[2].ccsArray.location}'>`
                );
          ...
          if (clickCount == 12) {
            $.ajax({
              ...
              success: function (data) {
                ...
                $('#hand-panel-ccs').append(
                  `<img id="ccName" class="hand-panel-cc" src='${data.updatePlayers3[3].ccsArray.location}'>`
                );
